...
export default function YouTubeForm() {
  const {
    ...
    defaultValues: {
      ...
      channel: "",
      social: {
        twitter: "hello@gmail.com",
        facebook: "world@gmail.com",
      },
      phoneNumbers: ["", ""],
      phNumbers: [{ number: "" }],
      age: 0,
  ...
  return (
    <div>
      <h1>YouTube Form ({countRerender / 2})</h1>
            ...
            {...register("email", {
              ...
              validate: {
                ...
                emailAvailable: async (fieldValue) => {
                  ...
                  return data.length == 0 || "Already exists in database";
                },
              },
            })}
          />
        ...
        <div className="form-control">
          ...
          <input
            ...
            {...register("social.facebook", {
              ...
              required: { value: true, message: "Facebook ID is required" },
            })}
          />
